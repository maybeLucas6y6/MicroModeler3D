...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_DefaultOptions2_ = ImGuiColorEditFlags_Float | ImGuiColorEditFlags_DisplayRGB | ImGuiColorEditFlags_InputRGB | ImGuiColorEditFlags_PickerHueBar,
